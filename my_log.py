...
# -*- coding: utf-8 -*-
# @Author  : Jupiter
# @Email   : xfavor2top@gmail.com
# @Time    : 2021/6/15 22:14
# @Site    : R & D Department
...
cur_path = os.path.abspath(__file__)  # 当前文件路径
...
class HandleLog:
    ...
    def __init__(self):
        ...
        self.__all_log_path = os.path.join(log_path, self.__now_time + "_all" + ".log")  # 收集所有日志信息文件
        self.__error_log_path = os.path.join(log_path, self.__now_time + "_error" + ".log")  # 收集错误日志信息文件
